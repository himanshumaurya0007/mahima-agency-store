...
const ProductSchema = new Schema(
    {
        ...
        volumeUnit: {
            ...
            minlength: [1, MESSAGES.MIN_LENGTH(FIELDS.PRODUCT_VOLUME_UNIT, 1)],
            maxlength: [20, MESSAGES.MAX_LENGTH(FIELDS.PRODUCT_VOLUME_UNIT, 20)],
        },
        packSize: {
            type: String,
            trim: true,
            required: [true, MESSAGES.REQUIRED(FIELDS.PRODUCT_PACK_SIZE)],
            minlength: [2, MESSAGES.MIN_LENGTH(FIELDS.PRODUCT_PACK_SIZE, 2)],
            maxlength: [20, MESSAGES.MAX_LENGTH(FIELDS.PRODUCT_PACK_SIZE, 20)],
        },
        materialCode: {
            type: String,
            trim: true,
